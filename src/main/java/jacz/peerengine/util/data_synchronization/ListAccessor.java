...
import jacz.peerengine.util.data_synchronization.old.DataAccessException;
import jacz.peerengine.util.data_synchronization.old.ElementNotFoundException;
import jacz.peerengine.util.data_synchronization.old.IndexAndHash;
import jacz.peerengine.util.data_synchronization.old.ServerSynchRequestAnswer;
...
public interface ListAccessor {
    ...
    public enum TransmissionType {
        /**
         * Elements are sent directly, one by one
         */
        DIRECT,

        /**
         * Elements are sent via the peer engine data download utility, altogether (currently not supported)
         */
        INDIRECT,
    }
...
//    public List<Integer> getInnerListLevels(int level);
     ...
     * @throws jacz.peerengine.util.data_synchronization.old.ElementNotFoundException the given hash does not correspond to an existing element, so the inner list
     *                                  could not be found
     */
//    public ListAccessor getInnerList(String index, int level, boolean buildElementIfNeeded) throws ElementNotFoundException, DataAccessException;
     ...
     * @throws jacz.peerengine.util.data_synchronization.old.ElementNotFoundException the provided hash does not fit in any existing element
     */
     ...
     * @throws jacz.peerengine.util.data_synchronization.old.ElementNotFoundException the given hash does not correspond to an existing element in this list and
     *                                  at the given level
     */
     ...
     * @throws jacz.peerengine.util.data_synchronization.old.ElementNotFoundException
     */
