...
import jacz.peerengine.client.connection.RequestFromPeerToPeer;
...
public class PeerClientPrivateInterface {
    ...
    public synchronized void newChatMessageReceived(PeerID peerID, String message) {
        peerClient.newChatMessageReceived(peerID, message);
    }
