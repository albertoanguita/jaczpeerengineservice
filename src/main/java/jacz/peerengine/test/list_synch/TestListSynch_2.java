...
public class TestListSynch_2 {
    ...
    public static void main(String args[]) {
        String config = ".\\trunk\\src\\com\\jacuzzi\\peerengine\\test\\clientConf_2.xml";
        try {
            ...
            Client client = new Client(personalData, peerClientData, peerRelations, new SimplePeerClientActionImpl(), new HashMap<String, PeerFSMFactory>(), true, lists.element1, lists.element2);
            client.startClient();
