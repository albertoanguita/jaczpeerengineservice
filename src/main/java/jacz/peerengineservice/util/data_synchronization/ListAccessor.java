...
//    public List<Integer> getInnerListLevels(int level);
     ...
     * @throws jacz.peerengineservice.util.data_synchronization.old.ElementNotFoundException the given hash does not correspond to an existing element, so the inner list
     *                                  could not be found
     */
//    public ListAccessor getInnerList(String index, int level, boolean buildElementIfNeeded) throws ElementNotFoundException, DataAccessException;
     ...
     * @throws jacz.peerengineservice.util.data_synchronization.old.ElementNotFoundException the provided hash does not fit in any existing element
     */
     ...
     * @throws jacz.peerengineservice.util.data_synchronization.old.ElementNotFoundException the given hash does not correspond to an existing element in this list and
     *                                  at the given level
     */
     ...
     * @throws jacz.peerengineservice.util.data_synchronization.old.ElementNotFoundException
     */
