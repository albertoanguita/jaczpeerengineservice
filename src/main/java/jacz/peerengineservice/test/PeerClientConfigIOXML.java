...
//    private static PeerPersonalData.State readState(Element root) {
//        String strState = root.getChild(STATE).getText();
//        try {
//            PeerPersonalData.State state = PeerPersonalData.State.valueOf(strState);
//            if (state == null) {
//                state = PeerPersonalData.State.UNDEFINED;
//            }
//            return state;
//        } catch (Exception e) {
//            return PeerPersonalData.State.UNDEFINED;
//        }
//    }
//
